...
\BITSetup{
  ...
  info = {
    ...
    titleEn = {Automated Human Motion Analysis and Synthesis},
    author = 艾力,
    authorEn = Ali,
    studentId = 31xxxxxxxx,
    school = 计算机学院,
    schoolEn = Computer Science and Technology,
    supervisor = 艾力,  % 指导教师
    supervisorEn = Prof. ,
...
%    majorEn = Materials Science and Engineering,
    ...
    keywords = {动作分析；动作合成；姿态估计；动作预测；运动评估。},
    keywordsEn = motion analysis; motion synthesis; pose estimation; motion prediction; exercise
    analysis,
    %
